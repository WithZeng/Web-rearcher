...
$BackendCommand = "Set-Location -LiteralPath '$ProjectRoot'; powershell -ExecutionPolicy Bypass -File '$BackendScript' -SkipBootstrap -DevMode"
$FrontendCommand = "Set-Location -LiteralPath '$ProjectRoot'; powershell -ExecutionPolicy Bypass -File '$FrontendScript' -SkipBootstrap -DevMode"
...
Write-Host "1. FastAPI backend (reload mode)"
Write-Host "2. Next.js frontend (dev mode)"
Write-Host ""
